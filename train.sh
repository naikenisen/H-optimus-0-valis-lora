...
python train.py --data_dir dataset --output_dir checkpoints --epochs 20 --batch_size 2 --num_workers 2 --max_train_batches 100 --max_valid_batches 100 --image_size 224