...
python train.py --data_dir dataset --output_dir checkpoints --epochs 30 --batch_size 2 --num_workers 2 --max_train_batches 1000 --max_valid_batches 1000 --image_size 224